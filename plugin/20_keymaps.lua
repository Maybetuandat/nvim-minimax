...
-- m is for 'Map' and 'Markdown'. Common usage:
...
-- This is your VS Code style Real-time Preview
nmap_leader('mp', '<Cmd>PeekOpen<CR>',                   'Markdown Preview Open')
nmap_leader('mP', '<Cmd>PeekClose<CR>',                  'Markdown Preview Close')

-- You can keep this if you still want the in-editor decoration:
nmap_leader('mm', '<Cmd>RenderMarkdown toggle<CR>',     'Markdown Render Toggle')
...
-- Add this line:
nmap_leader('mm', '<Cmd>RenderMarkdown toggle<CR>',     'Markdown toggle')
...
vim.keymap.set('n', '\\', '<cmd>NvimTreeToggle<CR>', { desc = 'Toggle File Explorer', silent = true })
-- Chỉ cần nhấn Ctrl + l là bay sang phải, Ctrl + h là bay sang trái
vim.keymap.set('n', '<C-h>', '<C-w>h', { desc = 'Sang trái' })
vim.keymap.set('n', '<C-l>', '<C-w>l', { desc = 'Sang phải' })
-- Nhảy đến nơi định nghĩa hàm (Go to Definition)
vim.keymap.set('n', 'gd', vim.lsp.buf.definition, { desc = 'LSP Definition' })

-- Hiển thị tài liệu hướng dẫn nhanh (Hover)
vim.keymap.set('n', 'K', vim.lsp.buf.hover, { desc = 'LSP Hover' })

-- Đổi tên biến/hàm trên toàn bộ dự án (Rename)
vim.keymap.set('n', '<leader>rn', vim.lsp.buf.rename, { desc = 'LSP Rename' })

-- Xem danh sách các lỗi trong file (Diagnostics)
